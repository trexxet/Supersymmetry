...
eventManager.listen {
    PostMaterialEvent event ->
        ...
        customMetaItems.addItem(4009, "battery.ram")
            ...
            .setModelAmount(8)
            .setCreativeTabs(GregTechAPI.TAB_GREGTECH_TOOLS);
        customMetaItems.addItem(4010, "battery.ni_cd.lv")
            .addComponents(ElectricStats.createRechargeableBattery(120000, GTValues.LV))
            .setUnificationData(OrePrefix.battery, MarkerMaterials.Tier.LV)
            .setModelAmount(8)
            .setCreativeTabs(GregTechAPI.TAB_GREGTECH_TOOLS);
        customMetaItems.addItem(4011, "battery.ni_cd.mv")
        ...
        customMetaItems.addItem(4022, "battery.liion_nmc.ev")
            ...
            .setModelAmount(8)
            .setCreativeTabs(GregTechAPI.TAB_GREGTECH_TOOLS);
        customMetaItems.addItem(4023, "battery.lipol_nmc.ev")
            .addComponents(ElectricStats.createRechargeableBattery(4800000, GTValues.EV))
            .setUnificationData(OrePrefix.battery, MarkerMaterials.Tier.EV)
            .setModelAmount(8)
            .setCreativeTabs(GregTechAPI.TAB_GREGTECH_TOOLS);
        customMetaItems.addItem(4024, "battery.lipol_nmc.iv")
            .addComponents(ElectricStats.createRechargeableBattery(19200000, GTValues.IV))
            .setUnificationData(OrePrefix.battery, MarkerMaterials.Tier.IV)
            .setModelAmount(8)
            .setCreativeTabs(GregTechAPI.TAB_GREGTECH_TOOLS);
        // Hulls 4090-4100
