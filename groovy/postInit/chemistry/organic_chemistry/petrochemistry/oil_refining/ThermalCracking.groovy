...
// Visbreaking Separation 
    DT.recipeBuilder()
        ...
        .fluidOutputs(fluid('visbreaking_residue') * 560)
        .fluidOutputs(fractions.heavy_gas_oil.getCrude(150))
        .fluidOutputs(fractions.light_gas_oil.getCrude(265))
        .fluidOutputs(fractions.naphtha.getCrude(390))
        .fluidOutputs(fluid('sulfuric_fuel_gas') * 330)
        .duration(200)
        .EUt(30)
        .buildAndRegister()
    ...
    DT.recipeBuilder()
        ...
        .fluidOutputs(fluid('sulfuric_fuel_gas') * 280)
        .duration(200)
        .EUt(30)
        .buildAndRegister()
...
// Coking
    // Delayed Coking
        VACUUM_DT.recipeBuilder()
            ...
            .fluidOutputs(fractions.heavy_gas_oil.getCrude(335))
            .fluidOutputs(fractions.light_gas_oil.getCrude(200))
            .fluidOutputs(fractions.naphtha.getCrude(1500))
            .fluidOutputs(fluid('sulfuric_fuel_gas') * 1650)
            .circuitMeta(2)
            .duration(400)
            .EUt(30)
            .buildAndRegister()
