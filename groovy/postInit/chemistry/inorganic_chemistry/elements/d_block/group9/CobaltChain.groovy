...
ROASTER.recipeBuilder()
        .inputs(ore('dustCobaltOxide') * 12)
        .fluidInputs(fluid('oxygen') * 1000)
        .outputs(metaitem('dustCobaltTwoThreeOxide') * 14)
        .duration(80)
        .EUt(120)
        .buildAndRegister()
...
BR.recipeBuilder()
        ...
        .fluidOutputs(fluid('cobalt_sulfate_heptahydrate_solution') * 1000)
...
DISTILLERY.recipeBuilder()
        .fluidInputs(fluid('cobalt_sulfate_heptahydrate_solution') * 1000)
        .outputs(metaitem('dustCobaltSulfateHeptahydrate') * 27)
...
DRYER.recipeBuilder()
        .inputs(ore('dustCobaltSulfateHeptahydrate') * 27)
        .outputs(metaitem('dustAnhydrousCobaltSulfate') * 6)
        .duration(120)
        .EUt(120)
        .buildAndRegister()

MIXER.recipeBuilder()
        .inputs(ore('dustAnhydrousNickelSulfate') * 6)
