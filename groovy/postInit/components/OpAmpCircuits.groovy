...
CIRCUIT_ASSEMBLER.recipeBuilder()
        .inputs(metaitem('circuit_board.basic'), ore('component.resistor') * 2, ore('component.diode') * 2, ore('wireFineCopper') * 2, ore('boltTin') * 2)
        .inputs(metaitem('op_amp'))
        .fluidInputs(fluid('soldering_alloy') * 72)
...
CIRCUIT_ASSEMBLER.recipeBuilder()
        .inputs(metaitem('circuit.basic_integrated') * 2, ore('component.resistor') * 2, ore('component.diode') * 2, ore('wireFineAnnealedCopper') * 4)
...
CIRCUIT_ASSEMBLER.recipeBuilder()
        .inputs(metaitem('circuit.good_integrated') * 2, ore('component.inductor') * 2, ore('component.diode') * 2, ore('boltElectrum') * 8)
