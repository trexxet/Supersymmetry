...
MIXER.recipeBuilder()
        .circuitMeta(3)
        .inputs(ore('dustAnhydrousNickelSulfate') * 15)
        .inputs(ore('dustManganeseIiSulfate') * 9)
        .inputs(ore('dustAnhydrousCobaltSulfate') * 6)
        .fluidInputs(fluid('distilled_water') * 5000)
        .fluidOutputs(fluid('nmc_sulfate_slurry') * 5000)
        .duration(240)
        .EUt(120)
        .buildAndRegister()
...
BR.recipeBuilder()
        ...
        .fluidInputs(fluid('nmc_sulfate_slurry') * 1000)
        .outputs(metaitem('dustRawNmcHydroxide') * 5)
...
DRYER.recipeBuilder()
        .inputs(ore('dustRawNmcHydroxide') * 5)
        .outputs(metaitem('dustNmcHydroxide') * 5)
        .duration(120)
        .EUt(480)
        .buildAndRegister()

ROASTER.recipeBuilder()
        .inputs(ore('dustLithiumNitrate') * 5)
        .inputs(ore('dustNmcHydroxide') * 5)
        .outputs(metaitem('dustNmcFiveThreeTwo') * 4)
...
BENDER.recipeBuilder()
        .inputs(ore('foilAluminium'))
        .inputs(ore('dustNmcFiveThreeTwo'))
        .outputs(metaitem('cathode.nmc532'))
        .duration(200)
        .EUt(24)
        .buildAndRegister()
...
MIXER.recipeBuilder()
        .inputs(ore('dustLithiumHexafluorophosphate') * 8)
        .fluidInputs(fluid('ethylene_carbonate') * 5500)
        .fluidInputs(fluid('dimethyl_carbonate') * 5500)
...
ASSEMBLER.recipeBuilder()
        ...
        .outputs(metaitem('battery.liion_lco'))
        .duration(400)
        .EUt(480)
        .buildAndRegister()
